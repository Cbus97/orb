(function(){
  ...
  window.addEventListener('message',function(e){
    ...
    if(e.data.type==='orb-touchmove'){
      /* Apply directly — already throttled by rAF in iframe */
      doMove(e.data.x, e.data.y);
    }
  ...
  document.addEventListener('mousemove',function(e){
    ...
    if(!_mouseRaf){
      _mouseRaf=true;
      requestAnimationFrame(function(){ _mouseRaf=false; doMove(cx,cy); });
    }
  });
