(function(){
  ...
  console.log('[Orb Parent] script loaded, session in storage:',
    localStorage.getItem('orb_session')?'FOUND':'empty',
  ...
  iframe.addEventListener('load',function(){
    setTimeout(function(){
      var session=localStorage.getItem('orb_session');
      if(session){
