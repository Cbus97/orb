(function(){
  ...
  /* ════════════════════════════════════════
     ...
     ════════════════════════════════════════ */
  if(!isMobile){
    var dragging=false, firstMove=true, lastX=0, lastY=0;
    ...
    window.addEventListener('message',function(e){
      ...
      if(e.data.type==='orb-dragstart'){
        ...
        dragging=true;
        firstMove=true;
        /* Disable iframe pointer events so parent receives mousemove AND mouseup */
    ...
    document.addEventListener('mouseup',function(){
      if(!dragging) return;
      dragging=false;
      /* Small delay before restoring — prevents click firing on mouseup */
